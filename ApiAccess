...
public class ApiAccess {
    ...
    public static String connectToCountryIs(int r){
        ...
        try {
            ...
            URI worldClockByIP = new URI("https://api.country.is/");
            
            //Create connection class
            HttpURLConnection LocationConnection = (HttpURLConnection)worldClockByIP.toURL().openConnection();
            ...
            if(responseCode != 200){
                ...
                Scanner LocationScanner = new Scanner(worldClockByIP.toURL().openStream());
